...
def main(base_model, args, prompts):
    ...
    # Import and instantiate the selected method
    if args.method == "FreeSliders":
...
if __name__ == '__main__':
    ...
    parser.add_argument("--method", type=str, default="FreeSliders", choices=["FreeSliders", "TE"], help="Method to use for slider generation")
    ...
    parser.add_argument("--static", action='store_const', const=True, default=True, help="Use static prompts")
    parser.add_argument("--dynamic", action='store_const', const=True, default=False, help="Use dynamic prompts")

    args = parser.parse_known_args()

    if args[0].method in ["FreeSliders", "TE"]:
