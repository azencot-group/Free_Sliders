...
class GuidedDiffusion:
            ...
            if concept_type in text_embeddings:
                ...
                for i, prompt in enumerate(prompt_list):
                    ...
                    for seed in seeds:
                        ...
                        dir_name = f"{args.BaseModel}_sd_latents/Guided/{tag}/{args.guidance}/{args.guidance2}/{args.t}"
    ...
    def run_guided(self, latents, prompt_pair, prompts, timestep_to=15, timesteps=50,
